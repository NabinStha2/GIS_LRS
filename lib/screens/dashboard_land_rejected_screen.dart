...
class DashboardLandRejectedScreen extends StatefulWidget {
  const DashboardLandRejectedScreen({super.key});

  @override
  State<DashboardLandRejectedScreen> createState() =>
      DashboardLandRejectedScreenState();
}

class DashboardLandRejectedScreenState
    extends State<DashboardLandRejectedScreen> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<LandProvider>(context, listen: false).ownedRejectedSaleLand(
